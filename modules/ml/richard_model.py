...
df = pd.read_csv('/Users/dhani/foamvenv/telecom_churn/form-factory/modules/data/telchurn/tel_churn_clean.csv')
...
print("Features stage - 1 in data: "+ str(x.dtypes))
...
print("Features stage - 2 in data: "+ str(X_new.dtypes))
...
# according to the feature selection we have selected 13 top features out of 19 features
# # Train Test Split
...
print("Features Final state: "+str(x_train.dtypes))
...
gb_smote_model.fit(x_train,y_train)

##best_estimator_

#Save the Selected Trained Model for loading and making predictions later
joblib.dump(gb_smote_model, '/Users/dhani/foamvenv/telecom_churn/form-factory/modules/data/telchurn/gradient_boosting_model.joblib')
